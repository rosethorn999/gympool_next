...
function DatePick({
	...
	return (
		<div className="DatePick flex w-full gap-2">
			...
			<div className="w-1/3 ">
				<select
					className="yyyy h-10 w-full rounded-2xl border-2 border-whisper bg-white px-2 leading-10"
					name="yyyy"
			...
			<div className="w-1/3">
				<select
					className="mm h-10 w-full rounded-2xl border-2 border-whisper bg-white px-2 leading-10"
					name="mm"
					onChange={handleChange}
					value={mm}
				>
			...
			<div className="w-1/3">
				<select
					className="dd  h-10 w-full rounded-2xl border-2 border-whisper bg-white px-2 leading-10"
					name="dd"
					onChange={handleChange}
					value={dd}
				>
